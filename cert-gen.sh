...
openssl req -new -x509 -days 3650 -extensions v3_ca -keyout ca.key -out ca.crt -nodes -subj '/CN=192.168.14.100'

# Generate Certificate  & Key for Server
openssl genrsa -out server.key 2048
openssl req -out server.csr -key server.key -new -sha256 -subj '/CN=192.168.14.100'
...
openssl req -out client.csr -key client.key -new -sha256 -subj '/CN=192.168.14.100'
